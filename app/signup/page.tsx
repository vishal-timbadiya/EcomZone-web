      ...
      <div className="w-full max-w-sm bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl p-6 space-y-6">
        ...
        {success ? (
          <div className="text-center py-8 space-y-4">
            <div className="w-20 h-20 bg-green-500/20 border-4 border-green-400/50 rounded-full flex items-center justify-center mx-auto">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
                  <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.95.684l1.09 3.268a1 1 0 00.95.684h6.14a1 1 0 00.95-.684l1.09-3.268a1 1 0 01.95-.684H19a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"/>
                  </svg>
                </div>
                <input
                  type="tel"
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-300 focus:ring-orange-400" required />
              <span className="text-xs text-gray-600">Agree to Terms & Privacy</span>
            </label>
