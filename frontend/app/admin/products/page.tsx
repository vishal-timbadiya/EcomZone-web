      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-6">
          <div className="animate-fade-in">
            <h1 className="text-6xl font-black bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent drop-shadow-lg mb-2">
              🛍️ Products
            </h1>
            <p className="text-xl text-gray-600 mt-3 max-w-md leading-relaxed">Complete inventory management with advanced bulk operations and real-time analytics</p>
          </div>
          
          <div className="flex flex-wrap gap-4 animate-slide-up">
            <button
              onClick={() => setShowProductForm(true)}
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-600 text-white font-bold rounded-3xl shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 text-lg flex items-center gap-3 hover:scale-105"
            >
            ...
            <button
              ...
              className="group px-8 py-4 bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 text-white font-bold rounded-3xl shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 text-lg cursor-pointer flex items-center gap-3 hover:scale-105"
            >
            ...
            {selectedIds.size > 0 && (
              <button
                ...
                className="group px-8 py-4 bg-gradient-to-r from-red-500 via-rose-500 to-pink-500 text-white font-bold rounded-3xl shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 text-lg hover:scale-105"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {[
            ...
            <div key={index} className="group bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 hover:border-blue-200 animate-fade-in-up" style={{animationDelay: `${index * 100}ms`}}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-4xl font-black text-gray-900 group-hover:text-gray-950 transition-colors">{value.toLocaleString()}</p>
                </div>
              </div>
        ...
        {/* Filters */}
        <div className="bg-white/70 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/50 mb-12">
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <div className="xl:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <select className="flex-1 px-5 py-4 border-2 border-gray-200 rounded-2xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 shadow-inner transition-all">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden animate-fade-in-up" style={{animationDelay: '400ms'}}>
          <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-6">
            <div className="flex items-center justify-between text-white">
              ...
              {selectedIds.size > 0 && (
                <div className="flex items-center gap-4 bg-white/20 p-4 rounded-2xl backdrop-blur-sm border border-white/30 animate-pulse">
                  <span className="font-bold text-lg">{selectedIds.size} Selected</span>
                  <button 
                    onClick={() => setShowBulkActions(true)}
                    className="px-6 py-3 bg-orange-500 text-white rounded-xl font-bold hover:bg-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                  >
                    ⚡ Bulk Edit
                  </button>
                  <button 
                    onClick={deleteSelected}
                    className="px-6 py-3 bg-red-500 text-white rounded-xl font-bold hover:bg-red-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                  >
                    🗑️ Delete All
                  </button>
                </div>
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-slate-50 to-gray-50">
                <tr>
                  ...
                  <th className="p-6 font-bold text-gray-900 w-80">Product Information</th>
                  <th className="p-6 font-bold text-gray-900 w-64">Pricing Details</th>
                  <th className="p-6 font-bold text-gray-900">Stock & Inventory</th>
                  <th className="p-6 font-bold text-gray-900 w-32">Categories</th>
                  <th className="p-6 font-bold text-gray-900 w-32">Status</th>
                  <th className="p-6 font-bold text-gray-900 w-48">Quick Actions</th>
                </tr>
              </thead>
                  ...
                  <tr key={product.id} className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 hover:shadow-md animate-fade-in-up border-b border-gray-50" style={{animationDelay: `${index * 50}ms`}}>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative group">
                          {product.imageUrls.length > 0 ? (
                            <div className="w-20 h-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl shadow-lg overflow-hidden hover:scale-110 transition-transform duration-300">
                              <img
                        ...
                        <div>
                          <h4 className="font-bold text-xl text-gray-900 mb-1 leading-tight">{product.name}</h4>
                          <p className="text-sm text-gray-600 mb-2">{product.productCode}</p>
                          <div className="flex flex-wrap gap-1">
                            {product.isBestseller && <span className="px-3 py-1 bg-yellow-200 text-yellow-800 text-xs font-bold rounded-full">⭐ Bestseller</span>}
                            {product.isNewArrival && <span className="px-3 py-1 bg-emerald-200 text-emerald-800 text-xs font-bold rounded-full">✨ New</span>}
                            {product.isTopRanking && <span className="px-3 py-1 bg-purple-200 text-purple-800 text-xs font-bold rounded-full">🏆 Top</span>}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="p-6">
                      <div className="space-y-2">
                        <div className="font-bold text-xl">₹{product.singlePrice.toLocaleString()}</div>
                    ...
                    <td className="p-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">{product.weight}g</div>
                        </div>
                      </div>
                    </td>
                    <td className="p-6">
                      <div className="space-y-1">
                        <span className="block px-3 py-2 bg-indigo-100 text-indigo-800 font-semibold rounded-xl text-sm">
                          {product.category}
                        </span>
                        <div className="flex flex-wrap gap-1 mt-2">
                          {product.categories.slice(0, 3).map((cat: string) => (
                            <span key={cat} className="px-2 py-1 bg-gray-200 text-gray-700 text-xs rounded-lg font-medium">
                              {cat}
                            </span>
                          ))}
                    ...
                    <td className="p-6">
                      <div className="flex flex-col sm:flex-row gap-2">
                        <button
                          ...
                          className="group flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:scale-105"
                        >
                        ...
                        <button
                          ...
                          className="group px-6 py-3 bg-gradient-to-r from-red-600 to-rose-600 text-white font-bold rounded-2xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:scale-105"
                        >
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-24">
              ...
              <button
                ...
                className="px-12 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-3xl text-lg shadow-2xl hover:shadow-3xl transition-all duration-300"
              >
                ➕ Add First Product
              </button>
            </div>
          ...
          {/* Pagination */}
          {filteredProducts.length > 0 && (
            <div className="border-t bg-gradient-to-r from-slate-50 to-gray-50 p-8">
              <div className="flex items-center justify-between">
                ...
                <nav className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-3 border border-gray-300 rounded-2xl text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-all shadow-sm"
                  >
                    ← Previous
                  </button>
                  ...
                  <div className="flex gap-1">
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => currentPage - 2 + i).filter(p => p >= 1 && p <= totalPages).map(page => (
                      <button
                        ...
                        className={`px-4 py-3 rounded-2xl text-sm font-semibold transition-all shadow-sm ${
                          page === currentPage
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {formData.imageUrl && (
                    <div className="relative group">
                      <img src={formData.imageUrl} alt="Primary" className="w-20 h-20 object-cover rounded-xl border-4 border-blue-200 shadow-lg hover:scale-110 transition-transform duration-300" />
                      <button
                        type="button"
              ...
              <div>
                ...
                {(formData.imageUrls && formData.imageUrls.length > 0) && (
                  <div className="mt-4">
                    <p className="text-sm text-gray-600 mb-3">Image Preview ({formData.imageUrls.length} images):</p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {formData.imageUrls.map((url: string, index: number) => (
                        <div key={index} className="relative group">
                          ...
                          {index === 0 && (
                            <div className="absolute top-2 left-2 bg-blue-500 text-white text-xs px-2 py-1 rounded-lg font-bold shadow-lg">
                              Primary
                            </div>
                          )}
                        </div>
          ...
          <div className="flex justify-end gap-4 pt-6 border-t">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:shadow-xl transition-all"
            >
...
function BulkImportModal({ onClose, onImport }: any) {
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      alert('Preview failed: Network error. Check your connection and try again.')
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const endpoint = isZipCsvUpload ? '/api/admin/products/bulk-upsert' : '/api/admin/products/bulk-save'
  ...
  const handleZipImport = async () => {
    ...
    try {
      ...
      const token = localStorage.getItem("adminToken")
      const res = await fetch('/api/admin/products/bulk-folder-import', {
        method: 'POST',
        headers: { 'Authorization': `Bearer ${token}` },
        body: formData
      })
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-8 border-b">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-3xl font-bold text-gray-900">Bulk Import Products</h2>
            <button
              onClick={onClose}
              className="p-2 hover:bg-gray-100 rounded-xl transition-colors"
            >
              ...
              <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-2 border-green-200 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  ...
                  <div className="group bg-white rounded-3xl p-8 text-center border-2 border-green-100 hover:border-green-300 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="text-5xl font-black text-green-600 mb-2">{completionStats.added}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className={`relative cursor-pointer rounded-2xl border-2 p-6 transition-all ${
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-gray-900">CSV Import</h4>
              ...
              <label className={`relative cursor-pointer rounded-2xl border-2 p-6 transition-all ${
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-gray-900">ZIP with Images</h4>
                    <p className="text-gray-600 text-sm mt-1">
